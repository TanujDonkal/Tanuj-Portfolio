            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  ...
                  web applications using React, TypeScript, and Node.js. Strong
                  foundation in REST API design, backend development, and
                  database integration, with experience in CI/CD pipelines and
                  testing workflows. Built production-style full-stack systems
                  including AI-assisted features and data-driven applications.
                </p>
                ...
                <div className="grid grid-cols-3 py-10 xl:py-16 gap-5 border-b border-mistGray">
                  {[
                    ...
                    { count: "05+", label: "Technologies Mastered" },
                  ].map((item, i) => (
                    <div key={i}>
                      <h3>{item.count}</h3>
